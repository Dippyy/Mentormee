...
class PopulateMentorInfoVC: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        UIApplication.sharedApplication().networkActivityIndicatorVisible = false
                ...
                let mentorInfo: NSArray = populateMentorInformation(InputData)
                println(mentorInfo)
...
//                var url:NSURL = NSURL(string:"http://mentormee.info/dbTestConnect/universityLookup.php")!
    ...
    func populateMentorInformation(inputID: NSString) -> NSArray {
        
        var post: NSString = "userID=\(inputID)"
        println(post)
